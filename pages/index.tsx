...
const Home: NextPage = () => {
  const colors = ['deeppink', 'deepskyblue', 'springgreen', 'crimson', 'yellow', 'darkviolet', 'crimson'];
  ...
  return (
    <div className=''>
      ...
      <main className='relative min-h-[100vh] mx-auto max-w-6xl flex flex-col items-center px-4'>
        <div className='w-full pt-12 pb-24 flex flex-col items-center'>
          <ConnectButton />
          <h1 className='text-5xl sm:text-7xl text-center mt-8 mb-4 text-white'>Görli Nfts</h1>
          <p className='text-[#AFEEEE] text-center mb-12'>Quickly mint all of the nfts you need for testing.</p>
            ...
            <div className="flip order-1 sm:order-2 mb-8 sm:mb-0">
              <div className="flip-content">
                <div className="flip-front">
                  <svg onMouseLeave={() => setColor(colors[Math.floor(Math.random() * colors.length)])} className="order-1 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200" style={{ background: color }}>
                ...
                <div className="flip-back">
                  <div className='w-[200px] h-[200px] cursor-pointer bg-gray-600 pt-6 px-3 border border-white'>
                    <p className='text-white text-sm '>
                      {`{"token":"1", "image":"data:image /svg+xml;base64...", "attributes": [{"trait_type": "Type", "value":" ${color}"}]}`}
                    </p>
                  </div>
                </div>
              </div>
